...
static size_t saveLumaIniConfigToStr(char *out)
{
    ...
    if (VERSION_BUILD != 0) {
        sprintf(lumaVerStr, "BwahFW v%d.%d.%d", (int)VERSION_MAJOR, (int)VERSION_MINOR, (int)VERSION_BUILD);
    } else {
        sprintf(lumaVerStr, "BwahFW v%d.%d", (int)VERSION_MAJOR, (int)VERSION_MINOR);
    }
